...
function mos_author_details_func(){
    ...
    <div class="post-autor-details">
        ...
        <div class="text-part">
            <h4 class="author-name" itemprop="name"><a href="<?php echo home_url('/author/').get_the_author_meta('user_login') ?>" title="View all posts by <?php echo get_the_author_meta('display_name') ?>" rel="author" class="url fn n" itemprop="url"><?php echo get_the_author_meta('display_name') ?></a></h4>
